...
@section('title','Forms nâng cao')
@section('header','Forms nâng cao')
@section('link')
    <li><a href="#">Bảng điều khiển</a></li>
    <li><a href="#">Forms</a></li>
    <li class="active">Forms nâng cao</li>
@endsection
@section('content')
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" data-inputmask="'mask': '99/99/9999'">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" data-inputmask="'mask': '(999) 999-9999'">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" data-inputmask="'mask': '999-99-9999'">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" data-inputmask="'mask': '~9.99 ~9.99 999'">
                                    </div>
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Chọn mặc định</strong>
                            </div>
                            <div class="card-body">
                                <select data-placeholder="Choose a Country..." class="defaultsel">
                                        <option value=""></option>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Chọn tiêu chuẩn</strong>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Đa lựa chọn</strong>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Đa lựa chọn với các nhóm</strong>
                            </div>
                            <div class="card-body">
