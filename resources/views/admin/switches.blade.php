...
@section('header','Công tắc')
@section('link')
<li><a href="#">Bảng điều khiển</a></li>
<li><a href="#">Các yếu tố</a></li>
<li class="active">Công tắc</li>
@endsection
@section('content')
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <strong class="card-title">Công tắc 3d</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Công tắc mặc định</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Công tắc mặc định - Pills</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Công tắc phác thảo</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Công tắc phác thảo - Pills</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Thay đổi phác thảo</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Thay đổi phác thảo - Pills</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Công tắc với văn bản</strong>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Công tắc với văn bản - Pills</strong>
                </div>
                <div class="card-body">
