                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fontawesome-icon-list">
                            ...
                            <div id="new">
                                <h2 class="page-header">11 Icon mới trong 4.0</h2>
                            ...
                            <section id="web-application">
                                <h2 class="page-header">Icons ứng dụng web</h2>
                            ...
                            <section id="form-control">
                                <h2 class="page-header">Icons điều khiển form</h2>
                            ...
                            <section id="currency">
                                <h2 class="page-header">Icons tiền tệ</h2>
                            ...
                            <section id="text-editor">
                                <h2 class="page-header">Icons trình soạn thảo văn bản</h2>
                            ...
                            <section id="directional">
                                <h2 class="page-header">Icons định hướng</h2>
                            ...
                            <section id="video-player">
                                <h2 class="page-header">Icons video</h2>
