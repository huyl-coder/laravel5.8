                    ...
                    <div class="badges">
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted m-b-15">Sử dụng <code>.label</code> class,&nbsp; theo sau là một trong sáu class ngữ cảnh <code>.label-default</code>, <code>.label-primary</code>, <code>.label-success</code>,
                                        <code>.label-info</code>, <code>.label-warning</code> or <code>.label-danger</code>, trong một <code>&lt;span&gt;</code> yếu tố để tạo label:</p>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted m-b-15">Sử dụng <code>.badge</code> class với <code>&lt;span&gt;</code> yếu tố tạo badges:</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted m-b-15">Sử dụng <code>.label</code> class,&nbsp; theo sau là một trong sáu class ngữ cảnh <code>.label-default</code>, <code>.label-primary</code>, <code>.label-success</code>,
                                        <code>.label-info</code>, <code>.label-warning</code> or <code>.label-danger</code>, trong một <code>&lt;span&gt;</code> yếu tố tạo label:</p>
