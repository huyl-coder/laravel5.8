...
@section('title','Quản lý controller')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><i class="fa fa-tasks"></i> Danh sách Controller
                                    <button type="button" id='btn-add' onclick="location.href='{{route("QuanTriHeThong.Controller.Controllers.create")}}'" class="btn btn-success add">Thêm mới</button>
                                </strong>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 33px, 0px);">
                                                                <a class="dropdown-item edit" href="{{route('QuanTriHeThong.Controller.Controllers.edit',$list->id)}}"><i class="fa fa-edit"></i> Sửa</a>
                                                                <a class="dropdown-item delete" href='' data-url="{{route('QuanTriHeThong.Controller.Controllers.destroy',$list->id)}}"><i class="fa fa-times"></i> Xóa</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
