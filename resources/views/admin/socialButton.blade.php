...
@section('title','Nút xã hội')
@section('header','Nút xã hội')
@section('link')
    <li><a href="#">Bảng điều khiển</a></li>
    <li><a href="#">Các yếu tố</a></li>
    <li class="active">Nút xã hội</li>
@endsection
@section('content')
                ...
                <div class="social-buttons">
                    <div class="card icon-text">
                        <div class="card-header">
                            ...
                            <small>Sử dụng. <code style="text-transform:lowercase">&lt;button class="btn social facebook"&gt;&lt;span&gt;Facebook&lt;/span&gt;&lt;/button&gt;</code></small>
