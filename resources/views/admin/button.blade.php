                    ...
                    <div class="buttons">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Trạng thái disabled </strong>
                                        <small>Sử dụng class
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Nút với icon </strong>
                                        <small>Sử dụng <code>&lt;i&gt;</code></small>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Nút nhỏ với icon </strong>
                                        <small>Sử dụng class
                                        <code>.btn-sm</code>
                                    </small>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Nút hoạt động lớn </strong>
                                        <small>Sử dụng class
