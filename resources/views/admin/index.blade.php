...
<div class="content mt-3">
    ...
    <div class="col-sm-12">
        <div class="alert  alert-success alert-dismissible fade show" role="alert">
            <span class="badge badge-pill badge-success">Thành công</span> Bạn đã truy cập bảng điều khiển thành công.
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card text-white bg-flat-color-1">
            <div class="card-body pb-0">
                ...
                <p class="text-light">Thành viên online</p>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="small text-muted">Tháng 10 2019</div>
                    </div>
                    <!--/.col-->
                        ...
                        <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group mr-3" data-toggle="buttons" aria-label="First group">
                                ...
                                <label class="btn btn-outline-secondary active">
                                    <input type="radio" name="options" id="option2" checked=""> Tháng
                                </label>
                                <label class="btn btn-outline-secondary">
                                    <input type="radio" name="options" id="option3"> Năm
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <ul>
                    ...
                    <li class="hidden-sm-down">
                        <div class="text-muted">Độc nhất</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="stat-widget-one">
                    ...
                    <div class="stat-content dib">
                        <div class="stat-text">Khách hàng mới</div>
