    ...
    <script src="{{ asset('template/assets/js/menu.js')}}"></script>
    <script>
        ...
        $(function(){
            $('#module').change(function(){
                ...
                if(module1==0){
                    $('#controller').html('<option value="">-Không có dữ liệu-</option>');
                }else{
                    $.get('/quanlyhethong/action/controller/'+module1,function(data){
